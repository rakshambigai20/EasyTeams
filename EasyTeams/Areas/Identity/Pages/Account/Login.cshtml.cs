...
namespace EasyTeams.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        {
            //returnUrl ??= Url.Content("~/");
            returnUrl ??= Url.Action("Dashboard", "Staff");
            ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //{
                    //    HttpContext.Session.SetString("Admin", user.Id);
                    //}
                    //else if (userRoles.Contains("Manager"))
                    //{
                    //    HttpContext.Session.SetString("Manager", user.Id);
                    //}
                    //else if (userRoles.Contains("Staff"))
                    //{
                    //    HttpContext.Session.SetString("Staff", user.Id);
                    //}
