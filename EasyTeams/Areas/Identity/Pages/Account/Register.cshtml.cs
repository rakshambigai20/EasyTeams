...
namespace EasyTeams.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required] public string Register { get; set; }
        ...
        {
            HttpContext.Session.GetString("currentUserId");  
            ReturnUrl = returnUrl;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.Register == "RegisterStaff")
                {
                    ...
                    staff.WorkEmail= Input.Email;
                    staff.PhoneNumber = Input.PhoneNumber;
                    staff.Address = Input.Address;
                    staffService = new StaffService();
                    staffService.AddStaff(staff, currentUserId);
                }
